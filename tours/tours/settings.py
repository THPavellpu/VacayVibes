...
# SECRET_KEY = 'django-insecure-j3nub-@3(2e6waa&y5s1=h7lxt3!603xvp%2e!tv0pxt-ud*%_'
...
# STATIC_URL = '/static/'
# STATICFILES_DIRS = [BASE_DIR / 'main' / 'static']  # Path to your static folder
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'main' / 'static']  # local static files
